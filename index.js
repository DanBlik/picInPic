...
var selectMediaStream = function () { return __awaiter(void 0, void 0, void 0, function () {
    var selectMediaStream_1, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                selectMediaStream_1 = _a.sent();
                videoElem.srcObject = selectMediaStream_1;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, videoElem.requestPictureInPicture()];
            case 1:
                _a.sent();
